...
{
    internal static class GateIoErrorMapping
    {
        internal static ErrorCollection ErrorMapping { get; } = new ErrorCollection(
            [
                ...
                new ErrorInfo(ErrorType.SignatureInvalid, false, "Invalid signature", "INVALID_SIGNATURE"),
                ...
                new ErrorInfo(ErrorType.TimestampInvalid, false, "Timestamp expired", "REQUEST_EXPIRED"),
                ...
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Order quantity too small", "QUANTITY_NOT_ENOUGH", "AMOUNT_TOO_LITTLE", "SIZE_TOO_SMALL"),
                new ErrorInfo(ErrorType.QuantityInvalid, false, "Order quantity too large", "AMOUNT_TOO_MUCH", "SIZE_TOO_LARGE"),

                new ErrorInfo(ErrorType.PriceInvalid, false, "Limit price too far from current price", "PRICE_TOO_DEVIATED"),
                ...
                new ErrorInfo(ErrorType.BalanceInsufficient, false, "Insufficient balance", "FUTURES_BALANCE_NOT_ENOUGH", "BALANCE_NOT_ENOUGH", "MARGIN_BALANCE_NOT_ENOUGH", "INSUFFICIENT_AVAILABLE"),

                new ErrorInfo(ErrorType.OrderConfigurationRejected, false, "PostOnly order would fill immediately", "POC_FILL_IMMEDIATELY", "ORDER_POC_IMMEDIATE"),
                new ErrorInfo(ErrorType.OrderConfigurationRejected, false, "FillOrKill order would not fill immediately", "FOK_NOT_FILL", "ORDER_FOK"),
                new ErrorInfo(ErrorType.OrderConfigurationRejected, false, "Symbol is delisting, only reduceOnly and close orders are allowed", "CONTRACT_IN_DELISTING"),

                new ErrorInfo(ErrorType.TargetIncorrectState, false, "Order already closed", "ORDER_CLOSED", "ORDER_FINISHED"),
                new ErrorInfo(ErrorType.TargetIncorrectState, false, "Order already canceled", "ORDER_CANCELLED"),

                new ErrorInfo(ErrorType.RequestRateLimited, false, "Withdraw request frequency exceeds limit", "TOO_FAST"),
                new ErrorInfo(ErrorType.OrderRateLimited, false, "Too many open orders", "TOO_MANY_ORDERS"),
