...
namespace GateIo.Net.Objects.Models
{
    ...
    public record GateIoCrossMarginAccount
    {
        ...
        /// <summary>
        /// ["<c>interest</c>"] Interest value in USD
        /// </summary>
        ...
        /// <summary>
        /// ["<c>portfolio_margin_total</c>"] Total amount of the portfolio margin account
        /// </summary>
        [JsonPropertyName("portfolio_margin_total")]
        public decimal PortfolioMarginTotal { get; set; }
        /// <summary>
        /// ["<c>portfolio_margin_total_liab</c>"] Total liabilities of the portfolio margin account
        /// </summary>
        [JsonPropertyName("portfolio_margin_total_liab")]
        public decimal PortfolioMarginTotalLiabilities { get; set; }
        /// <summary>
        /// ["<c>portfolio_margin_total_equity</c>"] Total equity of the portfolio margin account
        /// </summary>
