...
namespace GateIo.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IGateIoUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, GateIoCredentials credentials, GateIoEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IGateIoRestClient GetRestClient(string userIdentifier, GateIoCredentials? credentials = null, GateIoEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IGateIoSocketClient GetSocketClient(string userIdentifier, GateIoCredentials? credentials = null, GateIoEnvironment? environment = null);
    }
}