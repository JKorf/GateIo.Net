...
namespace GateIo.Net.Interfaces.Clients
{
    ...
    public interface IGateIoUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, ApiCredentials credentials, GateIoEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IGateIoRestClient GetRestClient(string userIdentifier, ApiCredentials? credentials = null, GateIoEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IGateIoSocketClient GetSocketClient(string userIdentifier, ApiCredentials? credentials = null, GateIoEnvironment? environment = null);
    }
}