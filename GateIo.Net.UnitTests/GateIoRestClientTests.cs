...
namespace GateIo.Net.UnitTests
{
    ...
    public class GateIoRestClientTests
    {
        ...
        public void TestConstructorConfiguration()
        {
            ...
            Assert.That(((GateIoRestClientSpotApi)restClient.SpotApi).AuthenticationProvider.PublicKey, Is.EqualTo("123"));
            Assert.That(((GateIoSocketClientSpotApi)socketClient.SpotApi).AuthenticationProvider.PublicKey, Is.EqualTo("456"));
