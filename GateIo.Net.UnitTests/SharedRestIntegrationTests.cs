...
namespace GateIo.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IGateIoRestClientSpotApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddGateIo(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IGateIoRestClient>().SpotApi.SharedClient;
        }

        private IGateIoRestClientPerpetualFuturesApiShared GetFuturesRestClient()
        {
            ...
            var sp = collection.BuildServiceProvider();
            return sp.GetRequiredService<IGateIoRestClient>().PerpetualFuturesApi.SharedClient;
        }
